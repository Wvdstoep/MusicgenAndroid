...
import com.goal.aicontent.musicgen.musicprompt.elements.ModelSelectionButton
...
@Composable
fun ContinuGenView(viewModel: MusicPromptViewModel, navController: NavHostController, modifier: Modifier = Modifier) {
                    ...
                    Button(
                        ...
                        onClick = {
                            selectedFileUri?.let { uri ->
                                //viewModel.generateContinuationForFile(uri, promptText.text, context)
                            }
                        },
